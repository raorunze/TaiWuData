MetaUpgradeData =
{
	...
	HealthMetaUpgrade =
	{
		...
		Starting = true,
		CostTable = { 40, 60, 80, 100, 120, 140, 160, 180, 200, 220 },
	...
	BackstabMetaUpgrade =
	{
		...
		Starting = true,
		CostTable = { 10, 30, 50, 90, 140, 200, 270, 350, 440, 540 },
	...
	StoredAmmoVulnerabilityMetaUpgrade =
	{
		...
		Starting = true,
		CostTable = { 10, 30, 50, 70, 90, 110, 130, 150, 170, 190 },
	...
	VulnerabilityEffectBonusMetaUpgrade =
	{
		...
		Starting = true,
		CostTable = { 250, 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500 },
		Color = { 255, 255, 255, 255 },
	...
	RerollMetaUpgrade =
	{
		...
		CostTable = { 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 2750 },
