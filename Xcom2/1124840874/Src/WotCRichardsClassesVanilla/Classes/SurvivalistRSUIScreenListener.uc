...
class SurvivalistRSUIScreenListener extends UIScreenListener config(SurvivalistRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddSurvivalistPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddSurvivalistPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('SurvivalistPerkGTS'); //GTS SKILL
