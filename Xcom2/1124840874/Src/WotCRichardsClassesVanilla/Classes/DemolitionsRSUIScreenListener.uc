...
class DemolitionsRSUIScreenListener extends UIScreenListener config(DemolitionsRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddDemolitionsPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddDemolitionsPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('DemolitionsPerkGTS'); //GTS SKILL
