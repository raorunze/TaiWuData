...
class MarksmanRSUIScreenListener extends UIScreenListener config(MarksmanRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddMarksmanPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddMarksmanPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('MarksmanPerkGTS'); //GTS SKILL
