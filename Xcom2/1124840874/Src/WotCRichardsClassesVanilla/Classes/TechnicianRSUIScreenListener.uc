...
class TechnicianRSUIScreenListener extends UIScreenListener config(TechnicianRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddTechnicianPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddTechnicianPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('TechnicianPerkGTS'); //GTS SKILL
