...
class GunnerRSUIScreenListener extends UIScreenListener config(GunnerRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddGunnerPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddGunnerPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('GunnerPerkGTS'); //GTS SKILL
