...
class RiflemanRSUIScreenListener extends UIScreenListener config(RiflemanRSAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddRiflemanPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddRiflemanPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('RiflemanPerkGTS'); //GTS SKILL
